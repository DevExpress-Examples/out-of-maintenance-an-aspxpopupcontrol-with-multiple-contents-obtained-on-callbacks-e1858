<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="PopupControlContentUpdateOnCallback._Default" %>

<%@ Register Assembly="DevExpress.Web.v9.2" Namespace="DevExpress.Web.ASPxClasses" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v9.2" Namespace="DevExpress.Web.ASPxPopupControl" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v9.2" Namespace="DevExpress.Web.ASPxTabControl" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v9.2" Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>
			...
			<ContentCollection>
				<dx:PopupControlContentControl runat="server">
					...
					<dx:ASPxPageControl ID="pgcPageControl" runat="server" Width="100%" EnableCallBacks="True"
						ClientInstanceName="pageControl" ShowTabs="False">
